...
class SmartBulb(SmartDevice):
    ...
    @property
    def transition_period(self) -> int:
        """Return default transition period.

        :return: transition period in milliseconds
        :rtype: int
        """
    ...
    def set_hsv(self, hue: int, saturation: int, value: int, period: int = -1):
        """Set new HSV.
    ...
    def turn_off(self, period: int = -1) -> None:
        """Turn the bulb off.
    ...
    def turn_on(self, period: int = -1) -> None:
        """Turn the bulb on.
