...
@click.option('--transition', type=int, default=-1, required=False,
...
@cli.command()
@click.argument("temperature", type=click.IntRange(2500, 9000), default=None, required=False)
@click.option('--transition', type=int, default=-1, required=False,
              help='Transition period in milliseconds, default 500.')
@pass_dev
def temperature(dev: SmartBulb, temperature, transition):
